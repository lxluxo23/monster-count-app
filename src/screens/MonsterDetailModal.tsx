...
export default function MonsterDetailModal({
  ...
  const { isPlaying, toggle, currentTrack } = useMonsterSound(
    monster?.audio,
    visible,
    audioEnabled,
    volume
    ...
    >
      <View style={styles.overlay}>
        ...
        <View style={[styles.sheet, { borderTopColor: monster.color }]}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={styles.body} nestedScrollEnabled>
            {/* Nombre + close */}
            ...
            {/* Descripción */}
            {monsterDescription && <Text style={styles.description}>{monsterDescription}</Text>}
            ...
            {n && (
              <>
                <Text style={styles.sectionLabel}>
                  {t('detail.nutritionTitle', { volume: n.volume })}
                </Text>
