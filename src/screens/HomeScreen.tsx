  ...
  const handleAdd = async (): Promise<void> => {
    ...
    try {
      ...
      if (err instanceof RateLimitError) {
        Alert.alert(t('rateLimit.title'), t('rateLimit.exceeded', { minutes: err.waitMinutes }));
      } else {
        throw err;
      }
    } finally {
      ...
      >
        ...
        {dailyGoal > 0 && (
          <View style={styles.goalSection}>
            ...
            {today >= dailyGoal && <Text style={styles.goalDone}>{t('home.dailyGoalDone')}</Text>}
          </View>
        )}
